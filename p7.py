...
class Table:
    ...
    def calculDeGain(self):
        ...
        # Programme Principal
        table1 = Table(referance="A36B", matiere="Bois", poids=50, hauteur=20, longueur=100, largeur=30, prixVen=15000,
                       PrixFabri=10000)
        table2 = Table(referance="BN51D4", matiere="Or", poids=200, hauteur=40, longueur=50, largeur=20, prixVen=200000,
                       PrixFabri=95000)
